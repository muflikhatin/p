...
selected_page = st.sidebar.selectbox(
    ...
    ["Halaman Utama", "Halaman Crawling Data",
     "Halaman Preprocessing Data", "Halaman Term Frequency","Halaman K Means","Halaman lda knn kmeans", "Halaman Topic Modelling", "Halaman closeness centrality crawling", "Halaman closeness centrality"])
